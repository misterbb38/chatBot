...
//         // Messages système pour contrôler les réponses dans le domaine de la quincaillerie
//         const systemMessage = {
//             role: "system",
//             content: "Ты Twowin AI, интеллектуальный помощник для компании Twowin (https://twowin.ru/), онлайн-магазина строительных материалов и инструментов в России. Отвечай на вопросы сотрудников о товарах, инструментах, строительных материалах, сантехнике, электротоварах и других товарах для ремонта и строительства. Используй соответствующую терминологию отрасли. Если не знаешь точного ответа о конкретном товаре, предложи сотруднику проверить онлайн-каталог. Отвечай на русском языке."
//         };
...
// Configuration de l'API LM Studio
const LM_STUDIO_API = 'http://127.0.0.1:1234/v1/chat/completions';
const MODEL_NAME = 'deepseek-coder-v2-lite-instruct'; // ou le modèle que vous utilisez
